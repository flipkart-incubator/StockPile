#
#  Be sure to run `pod spec lint fk-ios-lib-caching.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/Flipkart/fk-ios-lib-caching"
  ...
  #s.dependency "fk-ios-lib-coredata"
